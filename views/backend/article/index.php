    ...
    <script>
        ...
        function fillTable(data, num) {
            ...
            $.each(data.dataList, function (index, obj) {
                ...
                info += '<td>' + obj.author_nickname + '</td>';
                ...
                info += '<td style="text-align: center;"><button name="btnModify" type="button" class="layui-btn layui-btn-sm" onclick="update(' + obj.id + ')">修改</button><button name="btnDelete" type="button" class="layui-btn layui-btn-sm layui-btn-danger" onclick="remove(' + obj.id + ')">删除</button></td>';
                info += '</tr>';
