...
<div class="container main-content" style="width: 1050px;">
    ...
    <div class="row title" style="height: 60px;margin-bottom: 30px;">
        ...
        <a href="/front/speak/index" style="display: inline-block;width: 100px;height: 30px;font-size: 16px;text-align: center;padding-top: 25px;font-family: -apple-system, BlinkMacSystemFont, PingFang-SC-Regular, Hiragino Sans GB, Microsoft Yahei, Arial, sans-serif;text-transform:uppercase;">碎碎念 </a>
