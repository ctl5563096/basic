...
<div style="width: 300px;position: fixed;right: -300px;top:50px;" class="card" id="message_broad">
    ...
    <?php foreach ($comment as $ck => $cv): ?>
        <div class="card-body border" style="margin: 3px">
            ...
            <P style="font-size: 8px"><?php echo $cv['name'] ?> 于 <?php echo date('Y-m-d H:i:s', $cv['created_at']) ?>
                留下他的足迹</P>
        </div>
    <?php endforeach; ?>
    <div class="card-body" style="float: right">
        <button type="button" class="btn btn-primary btn-sm" onclick="goMessageBoard()" style="float: right">查看更多留言
        </button>
    </div>
</div>
...
<div class="container main-content" style="width: 1050px;">
    ...
    <div class="row module" style="height: 180px">
        <div class="col-sm-3 hot">
            ...
            <h4 style="text-align: center;font-size: 24px;margin-top: 10px"><a
                        href="/front/index/article-list?module=php"><strong style="font-family: 'Microsoft YaHei UI'">P
                        H P 代 码 录</strong></a></h4>
        </div>
        <div class="col-sm-3 hot">
            ...
            <h4 style="text-align: center;font-size: 24px;margin-top: 10px"><a
                        href="/front/index/article-list?module=sql"><strong style="font-family: 'Microsoft YaHei UI'">mysql</strong></a>
            </h4>
        </div>
        <div class="col-sm-3 hot">
            ...
            <h4 style="text-align: center;font-size: 24px;margin-top: 10px"><a
                        href="/front/index/article-list?module=system"><strong
                            style="font-family: 'Microsoft YaHei UI'">操作系统</strong></a></h4>
        </div>
        <div class="col-sm-3 hot">
            <a href="/front/index/blog">
                <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1588759285737&di=cab165e622d2a77d4b54cb8302496413&imgtype=0&src=http%3A%2F%2Fie.bjd.com.cn%2Fimages%2F201910%2F30%2F5db942a9e4b0d15f72e52ef4.jpeg"
                     width="220px" height="150px">
            </a>
            <h4 style="text-align: center;font-size: 24px;margin-top: 10px"><a href="/front/index/blog"><strong
                            style="font-family: 'Microsoft YaHei UI'">博 主 介 绍</strong></a></h4>
        </div>
    </div>
    <div>
    ...
    <div class="row main" style="padding-top: 10px;padding-left: 10px">
        <div class="col-sm-7 border border-left-0 border-bottom-0 border-top-0 " style="margin-right: 50px ">
            <?php foreach ($data as $v): ?>
                <div style="margin-top:20px;padding-bottom: 30px"
                     class="article border border-left-0 border-right-0 border-top-0"
                     style="width: 545px;height: 415px">
                    ...
                    <h5 style="width: 400px">
                        发布时间:<?php echo date('Y-m-d H:i:s', $v['created_at']) ?>
                        &nbsp&nbsp&nbsp阅读人数: <?php echo $v['see_num'] ?>
                        &nbsp&nbsp&nbsp作者: <?php echo $v['author_nickname'] ?>
                    </h5>
                    <div>
                        <div class="text">
                    ...
                    <div style="padding-bottom: 10px">
                        <button type="button" class="btn btn-primary" style="float: left"
                                onclick="detail(<?php echo $v['id'] ?>)">查看详情
                        </button>
                        <button type="button" class="btn btn-danger" style="float: right;width: 40px"
                                onclick="hate(<?php echo $v['id'] ?>)">踩
                        </button>
                        <button type="button" class="btn btn-success"
                                style="float: right;width: 40px;margin-right: 10px"
                                onclick="like(<?php echo $v['id'] ?>)">点赞
                        </button>
                    </div>
                </div>
                <br>
        ...
        <div class="col-sm-4 border border-right-2" style="">
            ...
            <div class="card " style="margin-top: 10px">
                <div class="card-body" style="padding-top: 5px;padding-bottom: 5px;height: 50px">城&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;市
                    : <?php echo $weather['location']['name'] ?><img src="/header/city.png" class="rounded card-body"
                                                                     style="width: 50px;margin-left: 130px"></div>
                <div class="card-body" style="padding-top: 5px;padding-bottom: 5px;height: 50px">现在天气
                    : <?php echo $weather['now']['text'] ?><img
                            src="/black/<?php echo $weather['now']['code'] ?>@1x.png" class="rounded card-body"
                            style="width: 50px;margin-left: 130px"></div>
                <div class="card-body" style="padding-top: 5px;padding-bottom: 5px;height: 50px">气&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;温
                    : &nbsp;<?php echo $weather['now']['temperature'] ?>&#8451;
                </div>
                <div class="card-body weather border"
                     style="padding: 0px;display: none;margin-left: 10px;margin-right: 10px;margin-bottom: 10px;">
                    <div class="card-body" style="padding: 5px;">
                        明 天 天 气：
                        <div class="card-body" style="padding: 0px;">
                            白天天气 : <?php echo $moreWeather['daily'][1]['text_day'] ?>
                            <img src="/black/<?php echo $moreWeather['daily']['1']['code_day'] ?>@1x.png"
                                 class="rounded card-body" style="width: 50px;margin-left: 80px">
                        </div>
                        <div class="card-body" style="padding: 0px;">
                            晚间天气 : <?php echo $moreWeather['daily'][1]['text_night'] ?>
                            <img src="/black/<?php echo $moreWeather['daily']['1']['code_night'] ?>@1x.png"
                                 class="rounded card-body" style="width: 50px;margin-left: 80px">
                        </div>
                        <div class="card-body" style="padding: 0px;">
                            最高气温：<?php echo $moreWeather['daily'][1]['high'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            最低气温：<?php echo $moreWeather['daily'][1]['low'] ?>
                        </div>
                    </div>
                </div>
                <div class="card-body weather border"
                    ...
                    <div class="card-body" style="padding: 5px;">
                        ...
                        <div class="card-body" style="padding: 0px;">
                            ...
                            <img src="/black/<?php echo $moreWeather['daily'][2]['code_day'] ?>@1x.png"
                                 class="rounded card-body" style="width: 50px;margin-left: 80px">
                        </div>
                        <div class="card-body" style="padding: 0px;">
                            晚间天气 : <?php echo $moreWeather['daily'][2]['text_night'] ?>
                            <img src="/black/<?php echo $moreWeather['daily'][2]['code_night'] ?>@1x.png"
                                 class="rounded card-body" style="width: 50px;margin-left: 80px">
                        </div>
                        <div class="card-body" style="padding: 0px;">
                            最高气温：<?php echo $moreWeather['daily'][2]['high'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            最低气温：<?php echo $moreWeather['daily'][1]['low'] ?>
                        </div>
                    </div>
                </div>
                <div class="card-body" id="layerDemo" style="padding-top: 0px;padding-bottom: 0px;height: 50px">
                    <button type="button" class="btn btn-primary weatherButton" data-method="notice"
                            style="margin-left: 100px" onclick="getWeather()">查看明后两天天气
                    </button>
                </div>
            </div>
            ...
            <div class="card" style="margin-top: 10px">
                <div class="card-body">查看更多
                    <button type="button" class="btn btn-primary" style="float: right" onclick="personal()">MORE->
                    </button>
                </div>
            </div>
            ...
            <div class="card" style="margin-top: 50px">
                <div class="form-group card-body" style="padding-bottom: 0px;margin-bottom: 0px;">
                    ...
                    <div class="card-body" style="text-align: center">
                        <button type="button" class="btn btn-primary btn-sm" onclick="messageBoard()">留下你的痕迹
                            []~(~▽~)~*
                        </button>
                    </div>
                </div>
